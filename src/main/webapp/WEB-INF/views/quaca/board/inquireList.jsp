					...
					<div class="panel-content">
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-header center-block">
										<h1 class="modal-title fa-3x"><b>자주하는 질문 등록</b></h1>								  
									</div>
						...
						<div class="modal fade" id="boardUpdateModal" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-header center-block">
										<h1 class="modal-title fa-3x"><b>자주하는 질문 수정</b></h1>								  
									</div>
									<div class="modal-body" id="modal_body">
										<ul class="list-group">
											<li class="list-group-item">
...
<script type="text/javascript">
	...
	//1-1.[게시판 목록 호출] - 자주하는 질문 목록 가져오기
	function boardList(){
		$.ajax({
			url : express_docker+"notice/inquirelist",
			type : "POST",
			data : {
	...
	//1-2.[게시판 목록 호출] - 자주하는 질문 목록 table html (data = true)
	...
	//2.[게시판 상세정보 호출] - 자주하는 질문 정보 호춣 
	function boardInfo(sid){
		$.ajax({
			url : express_docker+"notice/inquireselect",
			type : "POST",
			data : {
				StoreId : "${userVO.storeId}",
				SID : sid
	...
	//3.[게시판 상세정보 수정] - 자주하는 질문 정보 수정 
	function boardUpdate(){
		if(validate('boardUpdateModal')){
			$.ajax({
				url : express_docker+"notice/inquireupdate",
				type : "POST",
				data : {
					StoreId : "${userVO.storeId}",
	...
	//4.[게시판 정보 등록] - 자주하는 질문 등록 처리
	function boardInsert(){
		if(validate('boardInsertModal')){
			$.ajax({
				url : express_docker+"notice/inquireinsert",
				type : "POST",
				data : {
					StoreId : "${userVO.storeId}",
