...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="resources/quaca/css/datagrid/datatables/datatables.bundle.css">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
    ...
    <body class="mod-bg-1 mod-nav-link ">
                    ...
                    <footer class="page-footer" role="contentinfo">
                        ...
                        <div>
                            <ul class="list-table m-0">
                                <li><a href="/index" class="text-secondary fw-700">About</a></li>
        ...
        <script src="resources/quaca/js/statistics/peity/peity.bundle.js"></script>
        ...
        <script src="resources/quaca/js/datagrid/datatables/datatables.bundle.js"></script>
        <script>
            /* defined datas */
